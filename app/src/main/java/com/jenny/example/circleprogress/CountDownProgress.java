...
public class CountDownProgress extends View {
    ...
    public CountDownProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CountDownProgress, defStyleAttr, 0);
    ...
    protected void initByAttributes(TypedArray attributes) {
        finishedStrokeColor = attributes.getColor(R.styleable.CountDownProgress_finished_color, default_finished_color);
        ...
        suffixTextSize = attributes.getDimension(R.styleable.CountDownProgress_suffix_text_size, default_suffix_text_size);
        suffixText = TextUtils.isEmpty(attributes.getString(R.styleable.CountDownProgress_suffix_text)) ? default_suffix_text : attributes.getString(R.styleable.CountDownProgress_suffix_text);
        suffixTextPadding = attributes.getDimension(R.styleable.CountDownProgress_suffix_text_padding, default_suffix_padding);
        bottomTextSize = attributes.getDimension(R.styleable.CountDownProgress_bottom_text_size, default_bottom_text_size);
        bottomText = attributes.getString(R.styleable.CountDownProgress_bottom_text);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        arcAngle = (float)(360 -Math.acos(1-arcBottomHeight/radius)*180/Math.PI*2);
